...
describe('XAIAdapter', () => {
  ...
  describe('translateSchema', () => {
    ...
    it('preserves default values (supported by XAI)', () => {
      const mcpTool: MCPTool = {
        name: 'default_tool',
  ...
  describe('translateAllTools', () => {
    it('translates multiple tools to XAI format', () => {
  ...
  describe('translateInvocation', () => {
    it('translates XAI function call with JSON string arguments to MCP format', () => {
      const xaiCall = {
        name: 'query_nodes',
        arguments: '{"query":"test query","limit":10}',
      }

      const result = adapter.translateInvocation(xaiCall)
    ...
    it('throws error for invalid call object', () => {
      expect(() => adapter.translateInvocation(null)).toThrow('Invalid xAI function call')
      expect(() => adapter.translateInvocation(undefined)).toThrow('Invalid xAI function call')
      expect(() => adapter.translateInvocation('string')).toThrow('Invalid xAI function call')
    })
    ...
    it('throws error for invalid JSON in arguments string', () => {
      ...
      expect(() => adapter.translateInvocation(xaiCall)).toThrow('arguments field is not valid JSON')
    })
